...
$connect = new PDO("mysql:host=localhost;dbname=openemr-dev", "root", "");
...
if(isset($_POST["query"]))
{
    ...
    $query = "
	SELECT code_text FROM codes
		WHERE code_type=119 AND code_text LIKE '%".$condition."%'
		ORDER BY id DESC
		LIMIT 10
	";
    ...
    {
        $data[] = array(
            'code_text'		=>	str_ireplace($condition, $replace_string, $row["code_text"])
        );
    }
