<?php /* Smarty version 2.6.33, created on 2022-05-17 00:27:43
         compiled from C:/laragon/www/openemr-dev/templates/prescription/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'headerTemplate', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 14, false),array('function', 'xlt', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 103, false),array('function', 'xla', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 109, false),array('function', 'amcCollect', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 126, false),array('function', 'html_options', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 163, false),array('function', 'html_radios', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 276, false),array('function', 'xlj', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 427, false),array('function', 'datetimepickerSupport', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 457, false),array('modifier', 'js_url', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 79, false),array('modifier', 'attr', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 110, false),array('modifier', 'text', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 111, false),array('modifier', 'attr_url', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 118, false),array('modifier', 'oeFormatShortDate', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 159, false),array('modifier', 'js_escape', 'C:/laragon/www/openemr-dev/templates/prescription/general_edit.html', 337, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
...
<?php echo '
 ...
 function drugselected(sel) {
  ...
  if (i >= 0) {
   ...
   f.quantity.value = d[8] > 0 ? d[8] : 1;
   f.disp_quantity.value = f.quantity.value;
   f.disp_fee_hiden.value = d[12] ?? 0;
   f.disp_fee.value = d[12] * f.quantity.value;
...
'?drug_id=' + <?php echo ((is_array($_tmp=$this->_tpl_vars['prescription']->get_drug_id())) ? $this->_run_mod_handler('js_url', true, $_tmp) : js_url($_tmp)); ?>
 ...
 function quantityChanged() {
  ...
  if (f.disp_quantity) {
   f.disp_quantity.value = f.quantity.value;
   f.disp_fee.value = f.disp_fee_hiden.value * f.quantity.value;
  }
 }
...
" />
                        <input type="hidden" name="disp_fee_hiden" value="0" />
                    <?php else: ?>&nbsp;
