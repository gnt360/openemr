<?php /* Smarty version 2.6.33, created on 2022-02-08 11:37:37
         compiled from C:/xampp/htdocs/openemr-dev/templates/insurance_companies/general_edit.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'attr', 'C:/xampp/htdocs/openemr-dev/templates/insurance_companies/general_edit.html', 14, false),array('function', 'xlt', 'C:/xampp/htdocs/openemr-dev/templates/insurance_companies/general_edit.html', 17, false),array('function', 'html_options', 'C:/xampp/htdocs/openemr-dev/templates/insurance_companies/general_edit.html', 112, false),)), $this); ?>
...
" onKeyDown="PreventIt(event)">
    ...
    <div class="form-row my-sm-2">
        ...
        <div class="col-sm-8">
            <input type="text" id="fax" name="fax" class="form-control" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['insurancecompany']->get_fax())) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" onKeyDown="PreventIt(event)">
        </div>
    </div>
    <div class="form-row my-sm-2">
